...
export class UserService {
   ...
   * @returns
   */
  async registrySendEmail(registrySendEmailDto: RegistrySendEmailDto) {
   ...
   * 分页查询用户
   */
  async getAllUser(getAllUser: GetAllDto) {
  ...
  async runData() {
    ...
    menu1.menuIcon = "SettingOutlined";
    await this.menuRepository.save(menu1);

    let menu4 = new Menu();
    menu4.name = "用户管理";
    menu4.path = "/system/user";
    menu4.component = "user";
    menu4.menuType = MenuType.C;
    menu4.menuIcon = "UserOutlined";
    menu4.parent = menu1;
    await this.menuRepository.save(menu4);


    let menu2 = new Menu();
    menu2.name = "角色管理";
    menu2.path = "/system/role";
    menu2.component = "role";
    menu2.menuType = MenuType.C;
    menu2.menuIcon = "TeamOutlined";
    menu2.parent = menu1;
    await this.menuRepository.save(menu2);

    let menu3 = new Menu();
    menu3.name = "菜单管理";
    menu3.path = "/system/menu";
    menu3.component = "menu";
    menu3.menuType = MenuType.C;
    menu3.menuIcon = "MenuOutlined";
    menu3.parent = menu1;
    await this.menuRepository.save(menu3);

    let menu5 = new Menu();
    menu5.name = "权限管理";
    menu5.path = "/system/permission";
    menu5.component = "permission";
    menu5.menuType = MenuType.C;
    menu5.menuIcon = "LockOutlined";
    menu5.parent = menu1;
    ...
    // 权限 - 权限
    let permission14 = new Permission();
    permission14.identifying = "create-permission";
    permission14.name = "新增权限";
    permission14.desc = "用户拥有新增权限权限";
    await this.permissionRepository.save(permission14);

    let permission15 = new Permission();
    permission15.identifying = "update-permission";
    permission15.name = "更新权限";
    permission15.desc = "用户拥有更新权限权限";
    await this.permissionRepository.save(permission15);

    let permission16 = new Permission();
    permission16.identifying = "delete-permission";
    permission16.name = "删除权限";
    permission16.desc = "用户拥有删除权限权限";
    ...
    let permission18 = new Permission();
    permission18.identifying = "distribution-permission";
    permission18.name = "分配权限";
    permission18.desc = "用户拥有为角色分配权限权限";
    await this.permissionRepository.save(permission18);


    let permission19 = new Permission();
    permission19.identifying = "distribution-menu";
    permission19.name = "分配菜单";
    ...
    await this.PermissionGroupRepository.save(permissionGroup5);
